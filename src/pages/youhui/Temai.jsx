...
import { TemaiWrap } from "./styledTemai";
          ...
          <ul className="brand-list clearfix">
            <li className="brand-item">
              <a href="http://m.shihuo.cn/youhui/brandSale?news_id=390342">
                ...
                />
                <img
                  src="http://shihuo.hupucdn.com/goods/style/201708/1716/a8418a3ae650e7c5c76eea45f2a2bcc1.png"
                  alt=""
                  className="brand-logo"
                />
                <div className="brand-tit">日高</div>
                <div className="brand-subtit">定金50抵450</div>
              </a>
            </li>
            <li className="brand-item">
              <a href="http://m.shihuo.cn/youhui/brandSale?news_id=390327">
                ...
                />
                <img
                  src="http://shihuo.hupucdn.com/goods/style/201708/1716/4ef177124aa7ba5eb5d6ef5c135ae057.png"
                  alt=""
                  className="brand-logo"
                />
                <div className="brand-tit">匹克</div>
                <div className="brand-subtit">不止5折</div>
              </a>
            </li>
            <li className="brand-item">
              <a href="http://m.shihuo.cn/youhui/brandSale?news_id=386857">
                ...
                />
                <img
                  src="http://shihuo.hupucdn.com/newslogo/201710/1814/cd232408542a3bafc7eb464f74909171.jpg"
                  alt=""
                  className="brand-logo"
                />
                <div className="brand-tit">dickies</div>
                <div className="brand-subtit">满11减10元</div>
              </a>
            </li>
            <li className="brand-item">
              <a href="http://m.shihuo.cn/youhui/brandSale?news_id=390339">
                ...
                />
                <img
                  src="http://shihuo.hupucdn.com/goods/style/201708/1716/6c79a6f7612a56c851451ca0f0929025.png"
                  alt=""
                  className="brand-logo"
                />
                <div className="brand-tit">铭瑄</div>
                <div className="brand-subtit">虎扑专享满600减180</div>
              </a>
            </li>
            <li className="brand-item">
              <a href="http://m.shihuo.cn/youhui/brandSale?news_id=390348">
                ...
                />
                <img
                  src="http://shihuo.hupucdn.com/goods/style/201708/1716/bf41e50f5ace374682d8f9e104a9a953.png"
                  alt=""
                  className="brand-logo"
                />
                <div className="brand-tit">UA</div>
                <div className="brand-subtit">虎扑专享满600减180</div>
              </a>
            </li>
            <li className="brand-item">
              <a href="http://m.shihuo.cn/youhui/brandSale?news_id=375523">
                ...
                />
                <img
                  src="http://shihuo.hupucdn.com/newslogo/201710/2312/e08733467eb951d4ff57debfbf97396e.jpg"
                  alt=""
                  className="brand-logo"
                />
                <div className="brand-tit">Sony索尼</div>
                <div className="brand-subtit">满48减10</div>
              </a>
            </li>
          </ul>
        </div>
